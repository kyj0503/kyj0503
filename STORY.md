...
**Backend & Infra Lead**
해커톤과 동아리 활동에서도 개발 리더로서 인프라 환경을 통일하고 의사결정을 주도했습니다.
...
* **개발 동아리 / 아우내 (2024. 03. ~ 2025. 02.)**
    * **Development:** 학점 인정 프로젝트 리드로서 위치 기반 서비스의 주소/위도/경도 복합 비교 로직을 도입해 데이터 중복을 방지했습니다.
    * **Mentoring:** 신입 부원들에게 Git 워크플로우와 Spring Boot 기초를 교육하며 동아리 전체의 기술 역량을 높이는 데 기여했습니다.
...
* **경남대학교 컴퓨터공학전공 (2020. 03. ~ 2024. 02.)**
    * 2학년 수료 후 편입, GPA: 4.04 / 4.5
* **부트캠프 / 구름톤 딥다이브 풀스택 개발자 과정 (2024. 11. ~ 2025. 06.)**
    * **Role:** 잔디 팀 백엔드 팀장
    * **Activities:** 매일 스크럼 회의를 주재하여 진행 상황을 공유하고 블로커를 해결했습니다. 또한, 팀원들의 실력에 맞춰 백로그를 세분화하여 분배하고, 매주 코드 리뷰와 병합을 직접 수행하며 코드 품질을 책임졌습니다.
