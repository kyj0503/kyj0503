...
초등학생 시절, 공유기 접근 권한이 없어 Hamachi VPN을 이용해 게임 서버를 직접 호스팅했습니다. 블로그 이웃 150여 명이 즐기던 인기 서버였으나, 악의적인 유저의 테러로 맵 데이터가 소실되는 사건을 겪었습니다. 당시 백업의 중요성을 뼈저리게 느꼈고, 이후 중학생 때부터는 **보안과 백업을 최우선으로 고려하는 습관**을 들여 데이터 소실이나 바이러스 감염 사고를 단 한 번도 겪지 않았습니다.
